...
export const ModelSelector = ({
  ...
  if (providerList.length === 0) {
    return (
      <div className="mb-2 p-4 rounded-lg border border-codeweaver-elements-borderColor bg-codeweaver-elements-prompt-background text-codeweaver-elements-textPrimary">
      ...
      <div className="relative flex w-full" onKeyDown={handleProviderKeyDown} ref={providerDropdownRef}>
        <div
          className={classNames(
            'w-full p-2 rounded-lg border border-codeweaver-elements-borderColor',
            'bg-codeweaver-elements-prompt-background text-codeweaver-elements-textPrimary',
            'focus-within:outline-none focus-within:ring-2 focus-within:ring-codeweaver-elements-focus',
            'transition-all cursor-pointer',
            isProviderDropdownOpen ? 'ring-2 ring-codeweaver-elements-focus' : undefined,
          )}
        ...
        >
          <div className="flex items-center justify-between">
            ...
            <div
              className={classNames(
                'i-ph:caret-down w-4 h-4 text-codeweaver-elements-textSecondary opacity-75',
        ...
        {isProviderDropdownOpen && (
          <div
            className="absolute z-20 w-full mt-1 py-1 rounded-lg border border-codeweaver-elements-borderColor bg-codeweaver-elements-background-depth-2 shadow-lg"
            role="listbox"
            id="provider-listbox"
          >
              ...
              <div className="relative">
                <input
                  ...
                  className={classNames(
                    ...
                    'bg-codeweaver-elements-background-depth-2 border border-codeweaver-elements-borderColor',
                    'text-codeweaver-elements-textPrimary placeholder:text-codeweaver-elements-textTertiary',
                    'focus:outline-none focus:ring-2 focus:ring-codeweaver-elements-focus',
                    'transition-all',
                  )}
                ...
                <div className="absolute left-2.5 top-1/2 -translate-y-1/2">
                  <span className="i-ph:magnifying-glass text-codeweaver-elements-textTertiary" />
                </div>
              </div>
            </div>
            ...
            <div
              className={classNames(
                ...
                '[&::-webkit-scrollbar-thumb]:bg-codeweaver-elements-borderColor',
                '[&::-webkit-scrollbar-thumb]:hover:bg-codeweaver-elements-borderColorHover',
                '[&::-webkit-scrollbar-thumb]:rounded-full',
                '[&::-webkit-scrollbar-track]:bg-codeweaver-elements-background-depth-2',
                '[&::-webkit-scrollbar-track]:rounded-full',
                'sm:[&::-webkit-scrollbar]:w-1.5 sm:[&::-webkit-scrollbar]:h-1.5',
                'sm:hover:[&::-webkit-scrollbar-thumb]:bg-codeweaver-elements-borderColor/50',
                'sm:hover:[&::-webkit-scrollbar-thumb:hover]:bg-codeweaver-elements-borderColor',
                'sm:[&::-webkit-scrollbar-track]:bg-transparent',
              )}
            >
              {filteredProviders.length === 0 ? (
                <div className="px-3 py-2 text-sm text-codeweaver-elements-textTertiary">No providers found</div>
              ) : (
                  ...
                  <div
                    ...
                    className={classNames(
                      ...
                      provider?.name === providerOption.name || focusedProviderIndex === index
                        ? 'bg-codeweaver-elements-background-depth-2'
                        : undefined,
                      focusedProviderIndex === index ? 'ring-1 ring-inset ring-codeweaver-elements-focus' : undefined,
                    )}
                    onClick={(e) => {
                      e.stopPropagation();
      ...
      <div className="relative flex w-full min-w-[70%]" onKeyDown={handleModelKeyDown} ref={modelDropdownRef}>
        <div
          className={classNames(
            ...
            'focus-within:outline-none focus-within:ring-2 focus-within:ring-codeweaver-elements-focus',
            'transition-all cursor-pointer',
            isModelDropdownOpen ? 'ring-2 ring-codeweaver-elements-focus' : undefined,
          )}
        ...
        {isModelDropdownOpen && (
          <div
            className="absolute z-10 w-full mt-1 py-1 rounded-lg border border-codeweaver-elements-borderColor bg-codeweaver-elements-background-depth-2 shadow-lg"
            role="listbox"
            id="model-listbox"
          >
            <div className="px-2 pb-2">
            ...
            >
              {modelLoading === 'all' || modelLoading === provider?.name ? (
                <div className="px-3 py-2 text-sm text-codeweaver-elements-textTertiary">Loading...</div>
              ) : filteredModels.length === 0 ? (
                <div className="px-3 py-2 text-sm text-codeweaver-elements-textTertiary">No models found</div>
              ) : (
                  ...
                  <div
                    ...
                    className={classNames(
                      ...
                      model === modelOption.name || focusedModelIndex === index
                        ? 'bg-codeweaver-elements-background-depth-2'
                        : undefined,
                      focusedModelIndex === index ? 'ring-1 ring-inset ring-codeweaver-elements-focus' : undefined,
                    )}
                    onClick={(e) => {
                      e.stopPropagation();
