      ...
      >
        <div
          className={classNames(
            ...
            'p-1 rounded-lg text-codeweaver-elements-item-contentAccent',
            'flex ',
          )}
        >
          ...
          <motion.button
            ...
            className=" p-1 rounded-lg bg-codeweaver-elements-item-backgroundAccent hover:bg-codeweaver-elements-artifacts-backgroundHover"
