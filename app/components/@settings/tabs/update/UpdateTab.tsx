                  ...
                  <div key={type} className="space-y-1">
                    ...
                    <div className="pl-4 space-y-1">
                      {filesOfType.map((file, index) => {
                        ...
                        return (
                          <div key={index} className="text-sm text-codeweaver-elements-textSecondary flex items-center gap-2">
                            <div
  ...
  return (
    <div className="flex flex-col gap-6">
      ...
      >
        ...
        <div>
          <h3 className="text-lg font-medium text-codeweaver-elements-textPrimary">Updates</h3>
          <p className="text-sm text-codeweaver-elements-textSecondary">Check for and manage application updates</p>
        </div>
      </motion.div>
      ...
      >
        <div className="flex items-center gap-3 mb-6">
          ...
          <h3 className="text-lg font-medium text-codeweaver-elements-textPrimary">Update Settings</h3>
        </div>

        <div className="space-y-4">
          <div className="flex items-center justify-between">
            <div>
              <span className="text-sm text-codeweaver-elements-textPrimary">Automatic Updates</span>
              <p className="text-xs text-codeweaver-elements-textSecondary">
          ...
          <div className="flex items-center justify-between">
            <div>
              <span className="text-sm text-codeweaver-elements-textPrimary">In-App Notifications</span>
              <p className="text-xs text-codeweaver-elements-textSecondary">Show notifications when updates are available</p>
            </div>
            <button
          ...
          <div className="flex items-center justify-between">
            <div>
              <span className="text-sm text-codeweaver-elements-textPrimary">Check Interval</span>
              <p className="text-xs text-codeweaver-elements-textSecondary">How often to check for updates</p>
            </div>
            <select
      ...
      >
        <div className="flex items-center justify-between mb-6">
          <div className="flex items-center gap-3">
            ...
            <h3 className="text-lg font-medium text-codeweaver-elements-textPrimary">Update Status</h3>
          </div>
        ...
        {updateProgress?.details?.currentCommit && updateProgress?.details?.remoteCommit && (
          <div className="mt-4 text-sm text-codeweaver-elements-textSecondary">
            <div className="flex items-center justify-between">
              <div>
                <p>
                  Updates are fetched from: <span className="font-mono">stackblitz-labs/codeweaver.diy</span> (
      ...
      <DialogRoot open={showUpdateDialog} onOpenChange={setShowUpdateDialog}>
        <Dialog>
          ...
          <DialogDescription>
            <div className="mt-4">
              <p className="text-sm text-codeweaver-elements-textSecondary mb-4">
                A new version is available from <span className="font-mono">stackblitz-labs/codeweaver.diy</span> (
                {isLatestBranch ? 'main' : 'stable'} branch)
              </p>
                ...
                <div className="mb-6">
                  ...
                  <div className="bg-[#F5F5F5] dark:bg-[#1A1A1A] rounded-lg p-3 space-y-2">
                    {updateProgress.details.commitMessages.map((msg, index) => (
                      <div key={index} className="text-sm text-codeweaver-elements-textSecondary flex items-start gap-2">
              ...
              {updateProgress?.details?.totalSize && (
                <div className="flex items-center gap-4 text-sm text-codeweaver-elements-textSecondary">
                  <div className="flex items-center gap-2">
