  ...
  return (
    <div className="flex flex-col gap-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
        ...
        <div className="p-4 rounded-lg bg-codeweaver-elements-background dark:bg-codeweaver-elements-background-depth-2 border border-codeweaver-elements-borderColor dark:border-codeweaver-elements-borderColor hover:border-codeweaver-elements-borderColorActive/70 dark:hover:border-codeweaver-elements-borderColorActive/70 transition-all duration-200 h-[180px] flex flex-col">
          <div className="flex items-center gap-2">
            <div className="i-ph:github-logo text-codeweaver-elements-item-contentAccent dark:text-codeweaver-elements-item-contentAccent w-4 h-4" />
            <div className="text-sm font-medium text-codeweaver-elements-textPrimary dark:text-codeweaver-elements-textPrimary">
              GitHub Connection
            </div>
          </div>
          {diagnosticResults ? (
            <>
              ...
              {diagnosticResults.localStorage.hasGithubConnection && (
                <>
                  <div className="text-xs text-codeweaver-elements-textSecondary dark:text-codeweaver-elements-textSecondary mt-2 flex items-center gap-1.5">
                    <div className="i-ph:user w-3.5 h-3.5 text-codeweaver-elements-item-contentAccent dark:text-codeweaver-elements-item-contentAccent" />
                    User: {diagnosticResults.localStorage.githubConnectionParsed?.user?.login || 'N/A'}
                  </div>
                  <div className="text-xs text-codeweaver-elements-textSecondary dark:text-codeweaver-elements-textSecondary mt-2 flex items-center gap-1.5">
                    <div className="i-ph:check-circle w-3.5 h-3.5 text-codeweaver-elements-item-contentAccent dark:text-codeweaver-elements-item-contentAccent" />
                    API Status:{' '}
                    <Badge
                      variant={
              ...
              {!diagnosticResults.localStorage.hasGithubConnection && (
                <Button
                  ...
                  variant="outline"
                  size="sm"
                  className="mt-auto self-start hover:bg-codeweaver-elements-item-backgroundActive/10 hover:text-codeweaver-elements-textPrimary dark:hover:bg-codeweaver-elements-item-backgroundActive/10 dark:hover:text-codeweaver-elements-textPrimary transition-colors"
                >
            ...
            <div className="flex items-center justify-center h-full">
              <div className="text-sm text-codeweaver-elements-textSecondary dark:text-codeweaver-elements-textSecondary flex items-center gap-2">
        ...
        <div className="p-4 rounded-lg bg-codeweaver-elements-background dark:bg-codeweaver-elements-background-depth-2 border border-codeweaver-elements-borderColor dark:border-codeweaver-elements-borderColor hover:border-codeweaver-elements-borderColorActive/70 dark:hover:border-codeweaver-elements-borderColorActive/70 transition-all duration-200 h-[180px] flex flex-col">
          <div className="flex items-center gap-2">
            <div className="i-codeweaver:netlify text-codeweaver-elements-item-contentAccent dark:text-codeweaver-elements-item-contentAccent w-4 h-4" />
            <div className="text-sm font-medium text-codeweaver-elements-textPrimary dark:text-codeweaver-elements-textPrimary">
              Netlify Connection
            </div>
          </div>
        ...
        <div className="p-4 rounded-lg bg-codeweaver-elements-background dark:bg-codeweaver-elements-background-depth-2 border border-codeweaver-elements-borderColor dark:border-codeweaver-elements-borderColor hover:border-codeweaver-elements-borderColorActive/70 dark:hover:border-codeweaver-elements-borderColorActive/70 transition-all duration-200 h-[180px] flex flex-col">
          <div className="flex items-center gap-2">
            <div className="i-si:vercel text-codeweaver-elements-item-contentAccent dark:text-codeweaver-elements-item-contentAccent w-4 h-4" />
            <div className="text-sm font-medium text-codeweaver-elements-textPrimary dark:text-codeweaver-elements-textPrimary">
              Vercel Connection
            </div>
          </div>
        ...
        <div className="p-4 rounded-lg bg-codeweaver-elements-background dark:bg-codeweaver-elements-background-depth-2 border border-codeweaver-elements-borderColor dark:border-codeweaver-elements-borderColor hover:border-codeweaver-elements-borderColorActive/70 dark:hover:border-codeweaver-elements-borderColorActive/70 transition-all duration-200 h-[180px] flex flex-col">
          <div className="flex items-center gap-2">
            <div className="i-si:supabase text-codeweaver-elements-item-contentAccent dark:text-codeweaver-elements-item-contentAccent w-4 h-4" />
            <div className="text-sm font-medium text-codeweaver-elements-textPrimary dark:text-codeweaver-elements-textPrimary">
              Supabase Connection
            </div>
          </div>
          {diagnosticResults ? (
            <>
              ...
              {diagnosticResults.localStorage.hasSupabaseConnection && (
                <>
                  <div className="text-xs text-codeweaver-elements-textSecondary dark:text-codeweaver-elements-textSecondary mt-2 flex items-center gap-1.5 truncate">
                    <div className="i-ph:link w-3.5 h-3.5 text-codeweaver-elements-item-contentAccent dark:text-codeweaver-elements-item-contentAccent flex-shrink-0" />
      ...
      <div className="flex flex-wrap gap-4">
        <Button
          ...
          disabled={isRunning}
          variant="outline"
          className="flex items-center gap-2 hover:bg-codeweaver-elements-item-backgroundActive/10 hover:text-codeweaver-elements-textPrimary dark:hover:bg-codeweaver-elements-item-backgroundActive/10 dark:hover:text-codeweaver-elements-textPrimary transition-colors"
        >
          {isRunning ? (
        ...
        <Button
          ...
          variant="outline"
          className="flex items-center gap-2 hover:bg-codeweaver-elements-item-backgroundActive/10 hover:text-codeweaver-elements-textPrimary dark:hover:bg-codeweaver-elements-item-backgroundActive/10 dark:hover:text-codeweaver-elements-textPrimary transition-colors disabled:opacity-50 disabled:cursor-not-allowed"
        >
          ...
          <Collapsible open={showDetails} onOpenChange={setShowDetails} className="w-full">
            <CollapsibleTrigger className="w-full">
              <div className="flex items-center justify-between p-4 rounded-lg bg-codeweaver-elements-background dark:bg-codeweaver-elements-background-depth-2 border border-codeweaver-elements-borderColor dark:border-codeweaver-elements-borderColor hover:border-codeweaver-elements-borderColorActive/70 dark:hover:border-codeweaver-elements-borderColorActive/70 transition-all duration-200">
                ...
                <ChevronDownIcon
                  className={classNames(
                    'w-4 h-4 transform transition-transform duration-200 text-codeweaver-elements-textSecondary dark:text-codeweaver-elements-textSecondary',
            ...
            <CollapsibleContent className="overflow-hidden">
              <div className="p-4 mt-2 rounded-lg bg-codeweaver-elements-background-depth-2 dark:bg-codeweaver-elements-background-depth-1 border border-codeweaver-elements-borderColor dark:border-codeweaver-elements-borderColor">
                <pre className="text-xs overflow-auto max-h-96 text-codeweaver-elements-textSecondary dark:text-codeweaver-elements-textSecondary">
