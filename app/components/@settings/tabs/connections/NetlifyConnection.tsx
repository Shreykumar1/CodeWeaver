...
export default function NetlifyConnection() {
      ...
      <div className="mt-6">
        <Collapsible open={isStatsOpen} onOpenChange={setIsStatsOpen}>
          <CollapsibleTrigger asChild>
            <div className="flex items-center justify-between p-4 rounded-lg bg-codeweaver-elements-background dark:bg-codeweaver-elements-background-depth-2 border border-codeweaver-elements-borderColor dark:border-codeweaver-elements-borderColor hover:border-codeweaver-elements-borderColorActive/70 dark:hover:border-codeweaver-elements-borderColorActive/70 transition-all duration-200">
              <div className="flex items-center gap-2">
                <div className="i-ph:chart-bar w-4 h-4 text-codeweaver-elements-item-contentAccent dark:text-codeweaver-elements-item-contentAccent" />
                <span className="text-sm font-medium text-codeweaver-elements-textPrimary dark:text-codeweaver-elements-textPrimary">
                  Netlify Stats
                </span>
              </div>
              <div
          ...
          <CollapsibleContent className="overflow-hidden">
            <div className="space-y-4 mt-4">
              <div className="flex flex-wrap items-center gap-4">
                <Badge
                  variant="outline"
                  className="flex items-center gap-1 text-codeweaver-elements-textPrimary dark:text-codeweaver-elements-textPrimary"
                >
                  <BuildingLibraryIcon className="h-4 w-4 text-codeweaver-elements-item-contentAccent" />
                ...
                <Badge
                  ...
                  className="flex items-center gap-1 text-codeweaver-elements-textPrimary dark:text-codeweaver-elements-textPrimary"
                >
                  <RocketLaunchIcon className="h-4 w-4 text-codeweaver-elements-item-contentAccent" />
                ...
                {lastUpdated && (
                  <Badge
                    ...
                    className="flex items-center gap-1 text-codeweaver-elements-textPrimary dark:text-codeweaver-elements-textPrimary"
                  >
                    <ClockIcon className="h-4 w-4 text-codeweaver-elements-item-contentAccent" />
              ...
              {sites.length > 0 && (
                <div className="mt-4 space-y-4">
                  <div className="bg-codeweaver-elements-background dark:bg-codeweaver-elements-background-depth-1 border border-codeweaver-elements-borderColor dark:border-codeweaver-elements-borderColor rounded-lg p-4">
                    <div className="flex items-center justify-between mb-4">
                      <h4 className="text-sm font-medium flex items-center gap-2 text-codeweaver-elements-textPrimary dark:text-codeweaver-elements-textPrimary">
                        <BuildingLibraryIcon className="h-4 w-4 text-codeweaver-elements-item-contentAccent dark:text-codeweaver-elements-item-contentAccent" />
                        Your Sites
                      </h4>
                      <Button
                        variant="outline"
                        ...
                        className="flex items-center gap-2 text-codeweaver-elements-textPrimary dark:text-codeweaver-elements-textPrimary hover:bg-codeweaver-elements-item-backgroundActive/10"
                      >
                        <ArrowPathIcon
                          className={classNames(
                            'h-4 w-4 text-codeweaver-elements-item-contentAccent dark:text-codeweaver-elements-item-contentAccent',
                    ...
                    <div className="space-y-3">
                      {sites.map((site, index) => (
                        <div
                          key={site.id}
                          className={classNames(
                            'bg-codeweaver-elements-background dark:bg-codeweaver-elements-background-depth-1 border rounded-lg p-4 transition-all',
                            activeSiteIndex === index
                              ? 'border-codeweaver-elements-item-contentAccent bg-codeweaver-elements-item-backgroundActive/10'
                              : 'border-codeweaver-elements-borderColor hover:border-codeweaver-elements-borderColorActive/70',
                          )}
                          onClick={() => {
                        ...
                        >
                          <div className="flex items-center justify-between">
                            <div className="flex items-center gap-2">
                              <CloudIcon className="h-5 w-5 text-codeweaver-elements-item-contentAccent dark:text-codeweaver-elements-item-contentAccent" />
                              <span className="font-medium text-codeweaver-elements-textPrimary dark:text-codeweaver-elements-textPrimary">
                                {site.name}
                              </span>
                            </div>
                            <div className="flex items-center gap-2">
                              ...
                              >
                                ...
                                <span className="text-codeweaver-elements-textPrimary dark:text-codeweaver-elements-textPrimary">
                          ...
                          <div className="mt-3 flex items-center gap-2">
                            <a
                              ...
                              className="text-sm flex items-center gap-1 transition-colors text-codeweaver-elements-link-text hover:text-codeweaver-elements-link-textHover dark:text-white dark:hover:text-codeweaver-elements-link-textHover"
                              onClick={(e) => e.stopPropagation()}
                            >
                              <CloudIcon className="h-3 w-3 text-codeweaver-elements-item-contentAccent dark:text-codeweaver-elements-item-contentAccent" />
                          ...
                          {activeSiteIndex === index && (
                            <>
                              <div className="mt-4 pt-3 border-t border-codeweaver-elements-borderColor">
                                <div className="flex items-center gap-2">
                                  {siteActions.map((action) => (
                                    <Button
                                      ...
                                      className="flex items-center gap-1 text-codeweaver-elements-textPrimary dark:text-codeweaver-elements-textPrimary"
                                    >
                                      <action.icon className="h-4 w-4 text-codeweaver-elements-item-contentAccent dark:text-codeweaver-elements-item-contentAccent" />
                                      {action.name}
                                    </Button>
                                  ))}
                                </div>
                              ...
                              {site.published_deploy && (
                                <div className="mt-3 text-sm">
                                  <div className="flex items-center gap-1">
                                    <ClockIcon className="h-4 w-4 text-codeweaver-elements-item-contentAccent dark:text-codeweaver-elements-item-contentAccent" />
                                    <span className="text-codeweaver-elements-textSecondary dark:text-codeweaver-elements-textSecondary">
                                      Published {formatDistanceToNow(new Date(site.published_deploy.published_at))} ago
                                    </span>
                                  </div>
                                  {site.published_deploy.branch && (
                                    <div className="flex items-center gap-1 mt-1">
                                      <CodeBracketIcon className="h-4 w-4 text-codeweaver-elements-item-contentAccent dark:text-codeweaver-elements-item-contentAccent" />
                                      <span className="text-codeweaver-elements-textSecondary dark:text-codeweaver-elements-textSecondary">
                    ...
                    <div className="bg-codeweaver-elements-background dark:bg-codeweaver-elements-background-depth-1 border border-codeweaver-elements-borderColor dark:border-codeweaver-elements-borderColor rounded-lg p-4">
                      ...
                      <div className="space-y-2">
                        {deploys.map((deploy) => (
                          <div
                            key={deploy.id}
                            className="bg-codeweaver-elements-background dark:bg-codeweaver-elements-background-depth-1 border border-codeweaver-elements-borderColor dark:border-codeweaver-elements-borderColor rounded-lg p-3"
                          >
                            <div className="flex items-center justify-between">
                              <div className="flex items-center gap-2">
                                <Badge
                              ...
                              <span className="text-xs text-codeweaver-elements-textSecondary dark:text-codeweaver-elements-textSecondary">
                                {formatDistanceToNow(new Date(deploy.created_at))} ago
                              </span>
                            </div>
                            {deploy.branch && (
                              <div className="mt-2 text-xs text-codeweaver-elements-textSecondary dark:text-codeweaver-elements-textSecondary flex items-center gap-1">
                                <CodeBracketIcon className="h-3 w-3 text-codeweaver-elements-item-contentAccent dark:text-codeweaver-elements-item-contentAccent" />
                                <span className="text-codeweaver-elements-textSecondary dark:text-codeweaver-elements-textSecondary">
                            ...
                            {deploy.deploy_url && (
                              <div className="mt-2 text-xs">
                                <a
                                  ...
                                  target="_blank"
                                  rel="noopener noreferrer"
                                  className="flex items-center gap-1 transition-colors text-codeweaver-elements-link-text hover:text-codeweaver-elements-link-textHover dark:text-white dark:hover:text-codeweaver-elements-link-textHover"
                                  onClick={(e) => e.stopPropagation()}
                                >
                                  <CloudIcon className="h-3 w-3 text-codeweaver-elements-item-contentAccent dark:text-codeweaver-elements-item-contentAccent" />
                            ...
                            <div className="flex items-center gap-2 mt-2">
                              ...
                              {deploy.state === 'ready' ? (
                                <Button
                                  ...
                                  className="flex items-center gap-1 text-codeweaver-elements-textPrimary dark:text-codeweaver-elements-textPrimary"
                                >
                                  <LockClosedIcon className="h-4 w-4 text-codeweaver-elements-item-contentAccent dark:text-codeweaver-elements-item-contentAccent" />
                                  Lock
                                </Button>
                              ) : (
                                <Button
                                  ...
                                  className="flex items-center gap-1 text-codeweaver-elements-textPrimary dark:text-codeweaver-elements-textPrimary"
                                >
                                  <LockOpenIcon className="h-4 w-4 text-codeweaver-elements-item-contentAccent dark:text-codeweaver-elements-item-contentAccent" />
                                  Unlock
                                </Button>
                              )}
                            </div>
                      ...
                      <div className="space-y-2">
                        {builds.map((build) => (
                          ...
                          >
                            ...
                            {build.error && (
                              <div className="mt-2 text-xs text-codeweaver-elements-textDestructive dark:text-codeweaver-elements-textDestructive flex items-center gap-1">
                                <XCircleIcon className="h-3 w-3 text-codeweaver-elements-textDestructive dark:text-codeweaver-elements-textDestructive" />
                                Error: {build.error}
                              </div>
                            )}
                          </div>
  ...
  return (
    <div className="space-y-6 bg-codeweaver-elements-background dark:bg-codeweaver-elements-background border border-codeweaver-elements-borderColor dark:border-codeweaver-elements-borderColor rounded-lg">
      <div className="p-6">
        <div className="flex items-center justify-between">
          <div className="flex items-center gap-2">
            ...
            <h2 className="text-lg font-medium text-codeweaver-elements-textPrimary">Netlify Connection</h2>
          </div>
        </div>

        {!connection.user ? (
          <div className="mt-4">
            <label className="block text-sm text-codeweaver-elements-textSecondary dark:text-codeweaver-elements-textSecondary mb-2">
              API Token
            </label>
            <input
              type="password"
              ...
              className={classNames(
                ...
                'text-codeweaver-elements-textPrimary placeholder-codeweaver-elements-textTertiary',
                'focus:outline-none focus:ring-1 focus:ring-codeweaver-elements-borderColorActive',
                'disabled:opacity-50',
              )}
            />
            <div className="mt-2 text-sm text-codeweaver-elements-textSecondary">
              <a
                href="https://app.netlify.com/user/applications#personal-access-tokens"
                target="_blank"
                rel="noopener noreferrer"
                className="text-codeweaver-elements-borderColorActive hover:underline inline-flex items-center gap-1"
              >
                Get your token
          ...
          <div className="flex flex-col w-full gap-4 mt-4">
            <div className="flex items-center gap-3">
              ...
              <span className="text-sm text-codeweaver-elements-textSecondary flex items-center gap-1">
