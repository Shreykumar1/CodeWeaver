      ...
      <div className="p-6 space-y-6">
        <div className="flex items-center justify-between">
          <div className="flex items-center gap-2">
            ...
            />
            <h3 className="text-base font-medium text-codeweaver-elements-textPrimary">Vercel Connection</h3>
          </div>
        </div>
        ...
        {!connection.user ? (
          <div className="space-y-4">
            <div>
              <label className="block text-sm text-codeweaver-elements-textSecondary mb-2">Personal Access Token</label>
              <input
                type="password"
          ...
          <div className="space-y-6">
            ...
            <div className="flex items-center gap-4 p-4 bg-[#F8F8F8] dark:bg-[#1A1A1A] rounded-lg">
              ...
              <img
                ...
                crossOrigin="anonymous"
                alt="User Avatar"
                className="w-12 h-12 rounded-full border-2 border-codeweaver-elements-borderColorActive"
              />
              <div>
                <h4 className="text-sm font-medium text-codeweaver-elements-textPrimary">
                  {connection.user?.username || connection.user?.user?.username || 'Vercel User'}
                </h4>
                <p className="text-sm text-codeweaver-elements-textSecondary">
            ...
            {fetchingStats ? (
              ...
              <div>
                <button
                  ...
                  className="w-full bg-transparent text-left text-sm font-medium text-codeweaver-elements-textPrimary mb-3 flex items-center gap-2"
                >
                  ...
                  <div className="grid gap-3">
                    {connection.stats.projects.map((project) => (
                      <a
                        ...
                        target="_blank"
                        rel="noopener noreferrer"
                        className="block p-4 rounded-lg border border-codeweaver-elements-borderColor hover:border-codeweaver-elements-borderColorActive transition-colors"
                      >
                        <div className="flex items-center justify-between">
                          <div>
                            <h5 className="text-sm font-medium text-codeweaver-elements-textPrimary flex items-center gap-2">
                              <div className="i-ph:globe w-4 h-4 text-codeweaver-elements-borderColorActive" />
                              {project.name}
                            </h5>
                            <div className="flex items-center gap-2 mt-2 text-xs text-codeweaver-elements-textSecondary">
                              {project.targets?.production?.alias && project.targets.production.alias.length > 0 ? (
                                <>
                                  <a
                                    ...
                                    target="_blank"
                                    rel="noopener noreferrer"
                                    className="hover:text-codeweaver-elements-borderColorActive"
                                  >
                          ...
                          {project.framework && (
                            <div className="text-xs text-codeweaver-elements-textSecondary px-2 py-1 rounded-md bg-[#F0F0F0] dark:bg-[#252525]">
                              <span className="flex items-center gap-1">
