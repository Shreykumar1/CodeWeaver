  ...
  return (
    <Dialog.Root open={isOpen} onOpenChange={onClose}>
      <Dialog.Portal>
        ...
        >
          <Dialog.Title className="text-lg font-medium text-codeweaver-elements-textPrimary mb-4">
            Create New Branch
          </Dialog.Title>
          ...
          <form onSubmit={handleSubmit}>
            <div className="space-y-4">
              <div>
                <label htmlFor="branchName" className="block text-sm font-medium text-codeweaver-elements-textSecondary mb-2">
                  Branch Name
                </label>
                <input
                  id="branchName"
              ...
              <div>
                <label
                  ...
                  className="block text-sm font-medium text-codeweaver-elements-textSecondary mb-2"
                >
                  Source Branch
                </label>
                <select
              ...
              <div className="mt-4 p-3 bg-[#F5F5F5] dark:bg-[#1A1A1A] rounded-lg">
                <h4 className="text-sm font-medium text-codeweaver-elements-textSecondary mb-2">Branch Overview</h4>
                <ul className="space-y-2 text-sm text-codeweaver-elements-textSecondary">
