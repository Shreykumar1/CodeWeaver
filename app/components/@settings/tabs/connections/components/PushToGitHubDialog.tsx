            ...
            >
              <Dialog.Content className="bg-white dark:bg-[#1E1E1E] rounded-lg border border-[#E5E5E5] dark:border-[#333333] shadow-xl">
                <div className="p-6 space-y-4">
                  ...
                  <div className="bg-codeweaver-elements-background-depth-2 dark:bg-codeweaver-elements-background-depth-3 rounded-lg p-3 text-left">
                    <p className="text-xs text-codeweaver-elements-textSecondary dark:text-codeweaver-elements-textSecondary-dark mb-2">
                      Repository URL
                    </p>
                    <div className="flex items-center gap-2">
                      <code className="flex-1 text-sm bg-codeweaver-elements-background dark:bg-codeweaver-elements-background-dark px-3 py-2 rounded border border-codeweaver-elements-borderColor dark:border-codeweaver-elements-borderColor-dark text-codeweaver-elements-textPrimary dark:text-codeweaver-elements-textPrimary-dark font-mono">
                        {createdRepoUrl}
                      </code>
                      <motion.button
                        onClick={() => {
                        ...
                        className="p-2 text-codeweaver-elements-textSecondary hover:text-codeweaver-elements-textPrimary dark:text-codeweaver-elements-textSecondary-dark dark:hover:text-codeweaver-elements-textPrimary-dark"
                  ...
                  <div className="bg-codeweaver-elements-background-depth-2 dark:bg-codeweaver-elements-background-depth-3 rounded-lg p-3">
                    <p className="text-xs text-codeweaver-elements-textSecondary dark:text-codeweaver-elements-textSecondary-dark mb-2">
                    ...
                    <div className="max-h-[200px] overflow-y-auto custom-scrollbar">
                      {pushedFiles.map((file) => (
                        <div
                          key={file.path}
                          className="flex items-center justify-between py-1 text-sm text-codeweaver-elements-textPrimary dark:text-codeweaver-elements-textPrimary-dark"
                        >
                          <span className="font-mono truncate flex-1">{file.path}</span>
                          <span className="text-xs text-codeweaver-elements-textSecondary dark:text-codeweaver-elements-textSecondary-dark ml-2">
              ...
              <Dialog.Content className="bg-white dark:bg-[#0A0A0A] rounded-lg p-6 border border-[#E5E5E5] dark:border-[#1A1A1A] shadow-xl">
                <div className="text-center space-y-4">
                  <motion.div
                    ...
                    className="mx-auto w-12 h-12 rounded-xl bg-codeweaver-elements-background-depth-3 flex items-center justify-center text-purple-500"
                  >
              ...
              <div className="p-6">
                <div className="flex items-center gap-4 mb-6">
                  <motion.div
                    ...
                    animate={{ scale: 1 }}
                    transition={{ delay: 0.1 }}
                    className="w-10 h-10 rounded-xl bg-codeweaver-elements-background-depth-3 flex items-center justify-center text-purple-500"
                  >
                ...
                <div className="flex items-center gap-3 mb-6 p-3 bg-codeweaver-elements-background-depth-2 dark:bg-codeweaver-elements-background-depth-3 rounded-lg">
                ...
                <form onSubmit={handleSubmit} className="space-y-4">
                  <div className="space-y-2">
                    ...
                    <input
                      ...
                      className="w-full px-4 py-2 rounded-lg bg-codeweaver-elements-background-depth-2 dark:bg-codeweaver-elements-background-depth-3 border border-[#E5E5E5] dark:border-[#1A1A1A] text-gray-900 dark:text-white placeholder-gray-400"
                      required
                    />
                  </div>
                      ...
                      <div className="space-y-2">
                        {recentRepos.map((repo) => (
                          <motion.button
                            ...
                            className="w-full p-3 text-left rounded-lg bg-codeweaver-elements-background-depth-2 dark:bg-codeweaver-elements-background-depth-3 hover:bg-codeweaver-elements-background-depth-3 dark:hover:bg-codeweaver-elements-background-depth-4 transition-colors group"
