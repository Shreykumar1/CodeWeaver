        ...
        <Dialog.Portal>
          ...
          <Dialog.Content className="fixed top-[50%] left-[50%] -translate-x-1/2 -translate-y-1/2 w-[90vw] md:w-[600px] max-h-[85vh] overflow-hidden bg-white dark:bg-[#1A1A1A] rounded-xl shadow-xl z-[51] border border-[#E5E5E5] dark:border-[#333333]">
            <div className="p-4 border-b border-[#E5E5E5] dark:border-[#333333] flex items-center justify-between">
              <Dialog.Title className="text-lg font-semibold text-codeweaver-elements-textPrimary dark:text-codeweaver-elements-textPrimary-dark">
              ...
              <Dialog.Close
                ...
                className={classNames(
                  ...
                  'text-codeweaver-elements-textTertiary hover:text-codeweaver-elements-textPrimary',
                  'dark:text-codeweaver-elements-textTertiary-dark dark:hover:text-codeweaver-elements-textPrimary-dark',
                  'hover:bg-codeweaver-elements-background-depth-2 dark:hover:bg-codeweaver-elements-background-depth-3',
                  'focus:outline-none focus:ring-2 focus:ring-codeweaver-elements-borderColor dark:focus:ring-codeweaver-elements-borderColor-dark',
                )}
              >
            ...
            <div className="p-4 border-b border-[#E5E5E5] dark:border-[#333333] flex items-center justify-between">
              <div className="flex items-center gap-2">
                ...
                <span className="text-sm text-codeweaver-elements-textSecondary dark:text-codeweaver-elements-textSecondary-dark">
                    ...
                    <div className="space-y-4 mb-4">
                      <div className="flex gap-2">
                        <input
                          ...
                          className="flex-1 px-4 py-2 rounded-lg bg-[#F5F5F5] dark:bg-[#252525] border border-[#E5E5E5] dark:border-[#333333] text-codeweaver-elements-textPrimary"
                        />
                        <button
                          onClick={() => setFilters({})}
                          className="px-3 py-2 rounded-lg bg-[#F5F5F5] dark:bg-[#252525] text-codeweaver-elements-textSecondary hover:text-codeweaver-elements-textPrimary"
                        >
                  ...
                  <div className="space-y-3 max-h-[400px] overflow-y-auto pr-2 custom-scrollbar">
                    {selectedRepository ? (
                      <div className="space-y-4">
                        ...
                        <div className="space-y-2">
                          <label className="text-sm text-codeweaver-elements-textSecondary">Select Branch</label>
                          <select
                            value={selectedBranch}
                            onChange={(e) => setSelectedBranch(e.target.value)}
                            className="w-full px-3 py-2 rounded-lg bg-codeweaver-elements-background-depth-2 dark:bg-codeweaver-elements-background-depth-3 border border-codeweaver-elements-borderColor dark:border-codeweaver-elements-borderColor-dark text-codeweaver-elements-textPrimary dark:text-codeweaver-elements-textPrimary-dark focus:outline-none focus:ring-2 focus:ring-codeweaver-elements-borderColor dark:focus:ring-codeweaver-elements-borderColor-dark"
                          >
                            {branches.map((branch) => (
                              <option
                                key={branch.name}
                                value={branch.name}
                                className="bg-codeweaver-elements-background-depth-2 dark:bg-codeweaver-elements-background-depth-3 text-codeweaver-elements-textPrimary dark:text-codeweaver-elements-textPrimary-dark"
                              >
    ...
    <button
      ...
      className={classNames(
        ...
        active
          ...
          : 'bg-[#F5F5F5] dark:bg-[#252525] text-codeweaver-elements-textPrimary dark:text-white hover:bg-[#E5E5E5] dark:hover:bg-[#333333] border border-[#E5E5E5] dark:border-[#333333]',
      )}
    >
      {children}
    </button>
...
function RepositoryList({
  ...
  if (isLoading) {
    return (
      <div className="flex items-center justify-center py-8 text-codeweaver-elements-textSecondary">
  ...
  if (repos.length === 0) {
    return (
      <div className="flex flex-col items-center justify-center py-8 text-codeweaver-elements-textSecondary">
...
function RepositoryCard({ repo, onSelect }: { repo: GitHubRepoInfo; onSelect: () => void }) {
  return (
    <div className="p-4 rounded-lg bg-codeweaver-elements-background-depth-1 border border-codeweaver-elements-borderColor hover:border-codeweaver-elements-borderColorActive/70 transition-colors">
      <div className="flex items-center justify-between mb-2">
        <div className="flex items-center gap-2">
          <span className="i-ph:git-branch text-codeweaver-elements-textTertiary" />
          <h3 className="font-medium text-codeweaver-elements-textPrimary dark:text-white">{repo.name}</h3>
        </div>
        <button
          onClick={onSelect}
      ...
      {repo.description && <p className="text-sm text-codeweaver-elements-textSecondary mb-3">{repo.description}</p>}
      <div className="flex items-center gap-4 text-sm text-codeweaver-elements-textTertiary">
        {repo.language && (
