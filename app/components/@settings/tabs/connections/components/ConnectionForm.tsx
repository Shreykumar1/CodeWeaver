    ...
    <div className="rounded-xl bg-white dark:bg-[#0A0A0A] border border-[#E5E5E5] dark:border-[#1A1A1A] overflow-hidden">
      <div className="p-6">
        <div className="flex items-center justify-between mb-6">
          <div className="flex items-center gap-3">
            <div className="p-2 rounded-lg bg-[#F5F5F5] dark:bg-[#1A1A1A] border border-[#E5E5E5] dark:border-[#1A1A1A]">
              <div className="i-ph:plug-fill text-codeweaver-elements-textTertiary" />
            </div>
            <div>
              <h3 className="text-lg font-medium text-codeweaver-elements-textPrimary">Connection Settings</h3>
              <p className="text-sm text-codeweaver-elements-textSecondary">Configure your GitHub connection</p>
            </div>
          </div>
        </div>
        ...
        <form onSubmit={onSave} className="space-y-4">
          <div>
            <label htmlFor="username" className="block text-sm font-medium text-codeweaver-elements-textSecondary mb-2">
              GitHub Username
            </label>
            <input
              id="username"
              ...
              className={classNames(
                ...
                'text-codeweaver-elements-textPrimary placeholder-codeweaver-elements-textTertiary text-base',
          ...
          <div>
            <div className="flex items-center justify-between mb-2">
              <label htmlFor="token" className="block text-sm font-medium text-codeweaver-elements-textSecondary">
          ...
          <div className="flex items-center justify-between pt-4 border-t border-[#E5E5E5] dark:border-[#1A1A1A]">
            ...
            {authState.rateLimits && (
              <div className="flex items-center gap-2 text-sm text-codeweaver-elements-textTertiary">
