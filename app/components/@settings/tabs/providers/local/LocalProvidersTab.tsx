...
export default function LocalProvidersTab() {
  ...
  return (
    <div
      className={classNames(
        'rounded-lg bg-codeweaver-elements-background text-codeweaver-elements-textPrimary shadow-sm p-4',
        'hover:bg-codeweaver-elements-background-depth-2',
        'transition-all duration-200',
      )}
      role="region"
    ...
    >
      ...
      >
        {/* Header section */}
        <div className="flex items-center justify-between gap-4 border-b border-codeweaver-elements-borderColor pb-4">
          <div className="flex items-center gap-3">
            ...
            <div>
              <div className="flex items-center gap-2">
                <h2 className="text-lg font-semibold text-codeweaver-elements-textPrimary">Local AI Models</h2>
              </div>
              <p className="text-sm text-codeweaver-elements-textSecondary">Configure and manage your local AI providers</p>
            </div>
          </div>

          <div className="flex items-center gap-2">
            <span className="text-sm text-codeweaver-elements-textSecondary">Enable All</span>
            <Switch
        ...
        {filteredProviders
          ...
          .map((provider) => (
            <motion.div
              key={provider.name}
              className={classNames(
                'bg-codeweaver-elements-background-depth-2 rounded-xl',
                'hover:bg-codeweaver-elements-background-depth-3',
                ...
                <div className="flex items-start gap-4">
                  <motion.div
                    className={classNames(
                      ...
                      'bg-codeweaver-elements-background-depth-3',
                      provider.settings.enabled ? 'text-purple-500' : 'text-codeweaver-elements-textSecondary',
                    )}
                  ...
                  <div>
                    <div className="flex items-center gap-2">
                      <h3 className="text-md font-semibold text-codeweaver-elements-textPrimary">{provider.name}</h3>
                      <span className="px-2 py-0.5 text-xs rounded-full bg-green-500/10 text-green-500">Local</span>
                    </div>
                    <p className="text-sm text-codeweaver-elements-textSecondary mt-1">
                ...
                {provider.settings.enabled && (
                  ...
                  >
                    <div className="flex flex-col gap-2">
                      <label className="text-sm text-codeweaver-elements-textSecondary">API Endpoint</label>
                      {editingProvider === provider.name ? (
                        <input
                          ...
                          className={classNames(
                            ...
                            'bg-codeweaver-elements-background-depth-3 border border-codeweaver-elements-borderColor',
                        ...
                        <div
                          ...
                          className={classNames(
                            ...
                            'bg-codeweaver-elements-background-depth-3 border border-codeweaver-elements-borderColor',
                            'hover:border-purple-500/30 hover:bg-codeweaver-elements-background-depth-4',
                            'transition-all duration-200',
                          )}
                        >
                ...
                <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }} className="mt-6 space-y-4">
                  <div className="flex items-center justify-between">
                    <div className="flex items-center gap-2">
                      ...
                      <h4 className="text-sm font-medium text-codeweaver-elements-textPrimary">Installed Models</h4>
                    </div>
                    {isLoadingModels ? (
                      <div className="flex items-center gap-2">
                        <div className="i-ph:spinner-gap-bold animate-spin w-4 h-4" />
                        <span className="text-sm text-codeweaver-elements-textSecondary">Loading models...</span>
                      </div>
                    ) : (
                      <span className="text-sm text-codeweaver-elements-textSecondary">
                    ...
                    {isLoadingModels ? (
                      <div className="space-y-3">
                        {Array.from({ length: 3 }).map((_, i) => (
                          <div
                            key={i}
                            className="h-20 w-full bg-codeweaver-elements-background-depth-3 rounded-lg animate-pulse"
                          />
                        ))}
                      </div>
                    ) : ollamaModels.length === 0 ? (
                      <div className="text-center py-8 text-codeweaver-elements-textSecondary">
                        <div className="i-ph:cube-transparent text-4xl mx-auto mb-2" />
                        <p>No models installed yet</p>
                        <p className="text-sm text-codeweaver-elements-textTertiary px-1">
                          Browse models at{' '}
                          <a
                      ...
                      ollamaModels.map((model) => (
                        <motion.div
                          ...
                          className={classNames(
                            'p-4 rounded-xl',
                            'bg-codeweaver-elements-background-depth-3',
                            'hover:bg-codeweaver-elements-background-depth-4',
                            'transition-all duration-200',
                          )}
                          whileHover={{ scale: 1.01 }}
                        >
                          <div className="flex items-center justify-between">
                            <div className="space-y-2">
                              <div className="flex items-center gap-2">
                                <h5 className="text-sm font-medium text-codeweaver-elements-textPrimary">{model.name}</h5>
                          ...
                          {model.progress && (
                            <div className="mt-3">
                              <Progress
                                ...
                                className="h-1"
                              />
                              <div className="flex justify-between mt-1 text-xs text-codeweaver-elements-textSecondary">
        ...
        <div className="border-t border-codeweaver-elements-borderColor pt-6 mt-8">
          <h3 className="text-lg font-semibold text-codeweaver-elements-textPrimary mb-4">Other Local Providers</h3>
