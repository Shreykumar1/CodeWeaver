    ...
    <div className="space-y-6">
      <div className="flex items-center justify-between pt-6">
        <div className="flex items-center gap-3">
          ...
          <div>
            <h3 className="text-lg font-semibold text-codeweaver-elements-textPrimary">Ollama Models</h3>
            <p className="text-sm text-codeweaver-elements-textSecondary mt-1">Install and manage your Ollama models</p>
          </div>
        </div>
        <motion.button
      ...
      <div className="flex gap-4">
        <div className="flex-1">
          <div className="space-y-1">
            ...
            />
            <p className="text-sm text-codeweaver-elements-textSecondary px-1">
              Browse models at{' '}
              <a
          ...
          <button
            ...
            className={classNames(
              ...
              selectedTags.includes(tag)
                ...
                : 'bg-codeweaver-elements-background-depth-3 text-codeweaver-elements-textSecondary hover:bg-codeweaver-elements-background-depth-4',
            )}
          >
            {tag}
          </button>
          ...
          >
            ...
            <div className="flex-1 space-y-1.5">
              <div className="flex items-start justify-between">
                <div>
                  <p className="text-codeweaver-elements-textPrimary font-mono text-sm">{model.name}</p>
                  <p className="text-xs text-codeweaver-elements-textSecondary mt-0.5">{model.desc}</p>
                </div>
                <div className="text-right">
                  <span className="text-xs text-codeweaver-elements-textTertiary">{model.size}</span>
                  {model.installedVersion && (
                    <div className="mt-0.5 flex flex-col items-end gap-0.5">
                      <span className="text-xs text-codeweaver-elements-textTertiary">v{model.installedVersion}</span>
              ...
              <div className="flex items-center justify-between">
                <div className="flex flex-wrap gap-1">
                  {model.tags.map((tag) => (
                    <span
                      key={tag}
                      className="px-1.5 py-0.5 rounded-full text-[10px] bg-codeweaver-elements-background-depth-4 text-codeweaver-elements-textTertiary"
                    >
                      {tag}
                    </span>
                  ))}
      ...
      {installProgress && (
        <motion.div initial={{ opacity: 0, y: 10 }} animate={{ opacity: 1, y: 0 }} className="space-y-2">
          <div className="flex justify-between text-sm">
            <span className="text-codeweaver-elements-textSecondary">{installProgress.status}</span>
            <div className="flex items-center gap-4">
              <span className="text-codeweaver-elements-textTertiary">
                {installProgress.downloadedSize} / {installProgress.totalSize}
              </span>
              <span className="text-codeweaver-elements-textTertiary">{installProgress.speed}</span>
              <span className="text-codeweaver-elements-textSecondary">{Math.round(installProgress.progress)}%</span>
            </div>
          </div>
