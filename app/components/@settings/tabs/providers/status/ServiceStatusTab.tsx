      ...
      >
        <div className="flex items-center justify-between gap-2 mt-8 mb-4">
          <div className="flex items-center gap-2">
            ...
            <div>
              <h4 className="text-md font-medium text-codeweaver-elements-textPrimary">Service Status</h4>
          ...
          <div className="flex items-center gap-2">
            ...
            <button
              ...
              className={classNames(
                ...
                'bg-codeweaver-elements-background-depth-3 hover:bg-codeweaver-elements-background-depth-4',
        ...
        <div className="p-4 bg-codeweaver-elements-background-depth-2 rounded-lg">
          <h5 className="text-sm font-medium text-codeweaver-elements-textPrimary mb-2">Test API Key</h5>
        ...
        {loading && serviceStatuses.length === 0 ? (
          <div className="text-center py-8 text-codeweaver-elements-textSecondary">Loading service statuses...</div>
        ) : (
                ...
                >
                  <div className="flex items-center justify-between gap-4">
                    <div className="flex items-center gap-3">
                      ...
                      <div>
                        <h4 className="text-sm font-medium text-codeweaver-elements-textPrimary">{service.provider}</h4>
                        <div className="space-y-1">
                          <p className="text-xs text-codeweaver-elements-textSecondary">
                            Last checked: {new Date(service.lastChecked).toLocaleTimeString()}
                          </p>
                          {service.responseTime && (
                            <p className="text-xs text-codeweaver-elements-textTertiary">
                              Response time: {Math.round(service.responseTime)}ms
                            </p>
                          )}
                          {service.message && (
                            <p className="text-xs text-codeweaver-elements-textTertiary">{service.message}</p>
                          )}
                        </div>
                      </div>
                    </div>
                  ...
                  {service.incidents && service.incidents.length > 0 && (
                    <div className="mt-2 border-t border-codeweaver-elements-borderColor pt-2">
                      <p className="text-xs font-medium text-codeweaver-elements-textSecondary mb-1">Recent Incidents:</p>
                      <ul className="text-xs text-codeweaver-elements-textTertiary space-y-1">
