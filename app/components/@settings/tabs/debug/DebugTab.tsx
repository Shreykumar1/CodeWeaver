    ...
    <Collapsible open={isOpen} onOpenChange={setIsOpen}>
      ...
      >
        <div className="flex items-center gap-3">
          <div className="i-ph:package text-codeweaver-elements-textSecondary w-4 h-4" />
          <span className="text-base text-codeweaver-elements-textPrimary">
            {title} Dependencies ({deps.length})
          </span>
        </div>
        <div className="flex items-center gap-2">
          <span className="text-sm text-codeweaver-elements-textSecondary">{isOpen ? 'Hide' : 'Show'}</span>
          <div
            className={classNames(
              'i-ph:caret-down w-4 h-4 transform transition-transform duration-200 text-codeweaver-elements-textSecondary',
              isOpen ? 'rotate-180' : '',
            )}
          />
        </div>
          ...
          <div className="space-y-2 p-4">
            {deps.map((dep) => (
              <div key={dep.name} className="flex items-center justify-between text-sm">
                <span className="text-codeweaver-elements-textPrimary">{dep.name}</span>
                <span className="text-codeweaver-elements-textSecondary">{dep.version}</span>
              </div>
            ))}
          </div>
        </ScrollArea>
...
export default function DebugTab() {
  ...
  const exportDebugInfo = () => {
    try {
      ...
      a.href = url;
      a.download = `codeweaver-debug-info-${new Date().toISOString()}.json`;
  ...
  const exportAsCSV = () => {
    try {
      ...
      const a = document.createElement('a');
      a.href = url;
      a.download = `codeweaver-debug-info-${new Date().toISOString()}.csv`;
      document.body.appendChild(a);
      a.click();
      window.URL.revokeObjectURL(url);
      document.body.removeChild(a);
  ...
  const exportAsPDF = () => {
    try {
      ...
      // Save the PDF
      doc.save(`codeweaver-debug-info-${new Date().toISOString()}.pdf`);
  ...
  const exportAsText = () => {
    try {
      ...
      const a = document.createElement('a');
      a.href = url;
      a.download = `codeweaver-debug-info-${new Date().toISOString()}.txt`;
      document.body.appendChild(a);
      a.click();
      window.URL.revokeObjectURL(url);
      document.body.removeChild(a);
              ...
              {exportFormats.map((format) => (
                <button
                  ...
                  className={classNames(
                    ...
                    'text-codeweaver-elements-textPrimary',
                  )}
                >
                  <div className={classNames(format.icon, 'w-5 h-5')} />
                  <div>
                    <div className="font-medium">{format.label}</div>
                    <div className="text-xs text-codeweaver-elements-textSecondary mt-0.5">
      ...
      <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
        ...
        <div className="p-4 rounded-xl bg-white dark:bg-[#0A0A0A] border border-[#E5E5E5] dark:border-[#1A1A1A] hover:border-purple-500/30 transition-all duration-200 h-[180px] flex flex-col">
          <div className="flex items-center gap-2">
            ...
            <div className="text-sm text-codeweaver-elements-textSecondary">Errors</div>
          </div>
          ...
          <div className="text-xs text-codeweaver-elements-textSecondary mt-2 flex items-center gap-1.5">
            <div
              className={classNames(
                'w-3.5 h-3.5',
        ...
        <div className="p-4 rounded-xl bg-white dark:bg-[#0A0A0A] border border-[#E5E5E5] dark:border-[#1A1A1A] hover:border-purple-500/30 transition-all duration-200 h-[180px] flex flex-col">
          <div className="flex items-center gap-2">
            ...
            <div className="text-sm text-codeweaver-elements-textSecondary">Memory Usage</div>
          </div>
          <div className="flex items-center gap-2 mt-2">
            <span
              className={classNames(
        ...
        <div className="p-4 rounded-xl bg-white dark:bg-[#0A0A0A] border border-[#E5E5E5] dark:border-[#1A1A1A] hover:border-purple-500/30 transition-all duration-200 h-[180px] flex flex-col">
          <div className="flex items-center gap-2">
            ...
            <div className="text-sm text-codeweaver-elements-textSecondary">Page Load Time</div>
          </div>
          <div className="flex items-center gap-2 mt-2">
            <span
              className={classNames(
        ...
        <div className="p-4 rounded-xl bg-white dark:bg-[#0A0A0A] border border-[#E5E5E5] dark:border-[#1A1A1A] hover:border-purple-500/30 transition-all duration-200 h-[180px] flex flex-col">
          <div className="flex items-center gap-2">
            ...
            <div className="text-sm text-codeweaver-elements-textSecondary">Network Speed</div>
          </div>
          <div className="flex items-center gap-2 mt-2">
            <span
              className={classNames(
        ...
        <div className="md:col-span-4 p-6 rounded-xl bg-white dark:bg-[#0A0A0A] border border-[#E5E5E5] dark:border-[#1A1A1A] hover:border-purple-500/30 transition-all duration-200 h-[260px] flex flex-col">
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-3">
              ...
              <div>
                <div className="text-base font-medium text-codeweaver-elements-textPrimary">Ollama Service</div>
                <div className="text-xs text-codeweaver-elements-textSecondary mt-0.5">{status.message}</div>
              </div>
            </div>
            <div className="flex items-center gap-3">
              <div className="flex items-center gap-2 px-2.5 py-1 rounded-full bg-codeweaver-elements-background-depth-3">
                <div
              ...
              <div className="text-[10px] text-codeweaver-elements-textTertiary flex items-center gap-1.5">
          ...
          <div className="mt-6 flex-1 min-h-0 flex flex-col">
            {status.status === 'Running' && ollamaStatus.models && ollamaStatus.models.length > 0 ? (
              <>
                <div className="text-xs font-medium text-codeweaver-elements-textSecondary flex items-center justify-between mb-3">
                  <div className="flex items-center gap-2">
                ...
                <div className="overflow-y-auto flex-1 scrollbar-thin scrollbar-thumb-gray-300 dark:scrollbar-thumb-gray-700 scrollbar-track-transparent hover:scrollbar-thumb-gray-400 dark:hover:scrollbar-thumb-gray-600">
                  <div className="grid grid-cols-2 gap-3 pr-2">
                    {ollamaStatus.models.map((model) => (
                      <div
                        key={model.name}
                        className="text-sm bg-codeweaver-elements-background-depth-3 hover:bg-codeweaver-elements-background-depth-4 rounded-lg px-4 py-3 flex items-center justify-between transition-colors group"
                      >
                        <div className="flex items-center gap-2 text-codeweaver-elements-textSecondary">
              ...
              <div className="flex-1 flex items-center justify-center">
                <div className="flex flex-col items-center gap-3 max-w-[280px] text-center">
                  ...
                  />
                  <span className="text-sm text-codeweaver-elements-textSecondary">{status.message}</span>
                </div>
              </div>
            )}
          </div>
        ...
        <CollapsibleTrigger className="w-full">
          <div className="flex items-center justify-between p-6 rounded-xl bg-white dark:bg-[#0A0A0A] border border-[#E5E5E5] dark:border-[#1A1A1A]">
            <div className="flex items-center gap-3">
              ...
              <h3 className="text-base font-medium text-codeweaver-elements-textPrimary">System Information</h3>
            </div>
            <div
              className={classNames(
        ...
        <CollapsibleContent>
          <div className="p-6 mt-2 rounded-xl bg-white dark:bg-[#0A0A0A] border border-[#E5E5E5] dark:border-[#1A1A1A]">
            {systemInfo ? (
              <div className="grid grid-cols-2 gap-6">
                <div className="space-y-2">
                  <div className="text-sm flex items-center gap-2">
                    <div className="i-ph:desktop text-codeweaver-elements-textSecondary w-4 h-4" />
                    <span className="text-codeweaver-elements-textSecondary">OS: </span>
                    <span className="text-codeweaver-elements-textPrimary">{systemInfo.os}</span>
                  </div>
                  <div className="text-sm flex items-center gap-2">
                    <div className="i-ph:device-mobile text-codeweaver-elements-textSecondary w-4 h-4" />
                    <span className="text-codeweaver-elements-textSecondary">Platform: </span>
                    <span className="text-codeweaver-elements-textPrimary">{systemInfo.platform}</span>
                  </div>
                  <div className="text-sm flex items-center gap-2">
                    <div className="i-ph:circuitry text-codeweaver-elements-textSecondary w-4 h-4" />
                    <span className="text-codeweaver-elements-textSecondary">Architecture: </span>
                    <span className="text-codeweaver-elements-textPrimary">{systemInfo.arch}</span>
                  </div>
                  <div className="text-sm flex items-center gap-2">
                    <div className="i-ph:cpu text-codeweaver-elements-textSecondary w-4 h-4" />
                    <span className="text-codeweaver-elements-textSecondary">CPU Cores: </span>
                    <span className="text-codeweaver-elements-textPrimary">{systemInfo.cpus}</span>
                  </div>
                  <div className="text-sm flex items-center gap-2">
                    <div className="i-ph:graph text-codeweaver-elements-textSecondary w-4 h-4" />
                    <span className="text-codeweaver-elements-textSecondary">Node Version: </span>
                    <span className="text-codeweaver-elements-textPrimary">{systemInfo.node}</span>
                  </div>
                  <div className="text-sm flex items-center gap-2">
                    <div className="i-ph:wifi-high text-codeweaver-elements-textSecondary w-4 h-4" />
                    <span className="text-codeweaver-elements-textSecondary">Network Type: </span>
                    <span className="text-codeweaver-elements-textPrimary">
                      {systemInfo.network.type} ({systemInfo.network.effectiveType})
                    </span>
                  </div>
                  <div className="text-sm flex items-center gap-2">
                    <div className="i-ph:gauge text-codeweaver-elements-textSecondary w-4 h-4" />
                    <span className="text-codeweaver-elements-textSecondary">Network Speed: </span>
                    <span className="text-codeweaver-elements-textPrimary">
                  ...
                  {systemInfo.battery && (
                    <div className="text-sm flex items-center gap-2">
                      <div className="i-ph:battery-charging text-codeweaver-elements-textSecondary w-4 h-4" />
                      <span className="text-codeweaver-elements-textSecondary">Battery: </span>
                      <span className="text-codeweaver-elements-textPrimary">
                  ...
                  <div className="text-sm flex items-center gap-2">
                    <div className="i-ph:hard-drive text-codeweaver-elements-textSecondary w-4 h-4" />
                    <span className="text-codeweaver-elements-textSecondary">Storage: </span>
                    <span className="text-codeweaver-elements-textPrimary">
                ...
                <div className="space-y-2">
                  <div className="text-sm flex items-center gap-2">
                    <div className="i-ph:database text-codeweaver-elements-textSecondary w-4 h-4" />
                    <span className="text-codeweaver-elements-textSecondary">Memory Usage: </span>
                    <span className="text-codeweaver-elements-textPrimary">
                      {systemInfo.memory.used} / {systemInfo.memory.total} ({systemInfo.memory.percentage}%)
                    </span>
                  </div>
                  <div className="text-sm flex items-center gap-2">
                    <div className="i-ph:browser text-codeweaver-elements-textSecondary w-4 h-4" />
                    <span className="text-codeweaver-elements-textSecondary">Browser: </span>
                    <span className="text-codeweaver-elements-textPrimary">
                      {systemInfo.browser.name} {systemInfo.browser.version}
                    </span>
                  </div>
                  <div className="text-sm flex items-center gap-2">
                    <div className="i-ph:monitor text-codeweaver-elements-textSecondary w-4 h-4" />
                    <span className="text-codeweaver-elements-textSecondary">Screen: </span>
                    <span className="text-codeweaver-elements-textPrimary">
                      {systemInfo.screen.width}x{systemInfo.screen.height} ({systemInfo.screen.pixelRatio}x)
                    </span>
                  </div>
                  <div className="text-sm flex items-center gap-2">
                    <div className="i-ph:clock text-codeweaver-elements-textSecondary w-4 h-4" />
                    <span className="text-codeweaver-elements-textSecondary">Timezone: </span>
                    <span className="text-codeweaver-elements-textPrimary">{systemInfo.time.timezone}</span>
                  </div>
                  <div className="text-sm flex items-center gap-2">
                    <div className="i-ph:translate text-codeweaver-elements-textSecondary w-4 h-4" />
                    <span className="text-codeweaver-elements-textSecondary">Language: </span>
                    <span className="text-codeweaver-elements-textPrimary">{systemInfo.browser.language}</span>
                  </div>
                  <div className="text-sm flex items-center gap-2">
                    <div className="i-ph:chart-pie text-codeweaver-elements-textSecondary w-4 h-4" />
                    <span className="text-codeweaver-elements-textSecondary">JS Heap: </span>
                    <span className="text-codeweaver-elements-textPrimary">
                  ...
                  <div className="text-sm flex items-center gap-2">
                    <div className="i-ph:timer text-codeweaver-elements-textSecondary w-4 h-4" />
                    <span className="text-codeweaver-elements-textSecondary">Page Load: </span>
                    <span className="text-codeweaver-elements-textPrimary">
                      {(systemInfo.performance.timing.loadTime / 1000).toFixed(2)}s
                    </span>
                  </div>
                  <div className="text-sm flex items-center gap-2">
                    <div className="i-ph:code text-codeweaver-elements-textSecondary w-4 h-4" />
                    <span className="text-codeweaver-elements-textSecondary">DOM Ready: </span>
                    <span className="text-codeweaver-elements-textPrimary">
              ...
              <div className="text-sm text-codeweaver-elements-textSecondary">Loading system information...</div>
            )}
          </div>
        </CollapsibleContent>
      </Collapsible>
        ...
        <CollapsibleTrigger className="w-full">
          <div className="flex items-center justify-between p-6 rounded-xl bg-white dark:bg-[#0A0A0A] border border-[#E5E5E5] dark:border-[#1A1A1A]">
            <div className="flex items-center gap-3">
              ...
              <h3 className="text-base font-medium text-codeweaver-elements-textPrimary">Performance Metrics</h3>
            </div>
            <div
              className={classNames(
                'i-ph:caret-down w-4 h-4 transform transition-transform duration-200',
              ...
              <div className="grid grid-cols-2 gap-4">
                <div className="space-y-2">
                  <div className="text-sm">
                    <span className="text-codeweaver-elements-textSecondary">Page Load Time: </span>
                    <span className="text-codeweaver-elements-textPrimary">
                      {(systemInfo.performance.timing.loadTime / 1000).toFixed(2)}s
                    </span>
                  </div>
                  <div className="text-sm">
                    <span className="text-codeweaver-elements-textSecondary">DOM Ready Time: </span>
                    <span className="text-codeweaver-elements-textPrimary">
                      {(systemInfo.performance.timing.domReadyTime / 1000).toFixed(2)}s
                    </span>
                  </div>
                  <div className="text-sm">
                    <span className="text-codeweaver-elements-textSecondary">Request Time: </span>
                    <span className="text-codeweaver-elements-textPrimary">
                      {(systemInfo.performance.timing.requestTime / 1000).toFixed(2)}s
                    </span>
                  </div>
                  <div className="text-sm">
                    <span className="text-codeweaver-elements-textSecondary">Redirect Time: </span>
                    <span className="text-codeweaver-elements-textPrimary">
                ...
                <div className="space-y-2">
                  <div className="text-sm">
                    <span className="text-codeweaver-elements-textSecondary">JS Heap Usage: </span>
                    <span className="text-codeweaver-elements-textPrimary">
                      {(systemInfo.performance.memory.usedJSHeapSize / (1024 * 1024)).toFixed(1)}MB /{' '}
                      {(systemInfo.performance.memory.totalJSHeapSize / (1024 * 1024)).toFixed(1)}MB
                    </span>
                  ...
                  <div className="text-sm">
                    <span className="text-codeweaver-elements-textSecondary">Heap Utilization: </span>
                    <span className="text-codeweaver-elements-textPrimary">
                      {systemInfo.performance.memory.usagePercentage.toFixed(1)}%
                    </span>
                  </div>
                  <div className="text-sm">
                    <span className="text-codeweaver-elements-textSecondary">Navigation Type: </span>
                    <span className="text-codeweaver-elements-textPrimary">
                  ...
                  <div className="text-sm">
                    <span className="text-codeweaver-elements-textSecondary">Redirects: </span>
                    <span className="text-codeweaver-elements-textPrimary">
        ...
        <CollapsibleTrigger className="w-full">
          <div className="flex items-center justify-between p-6 rounded-xl bg-white dark:bg-[#0A0A0A] border border-[#E5E5E5] dark:border-[#1A1A1A]">
            <div className="flex items-center gap-3">
              ...
              <h3 className="text-base font-medium text-codeweaver-elements-textPrimary">WebApp Information</h3>
        ...
        <CollapsibleContent>
          <div className="p-6 mt-2 rounded-xl bg-white dark:bg-[#0A0A0A] border border-[#E5E5E5] dark:border-[#1A1A1A]">
            {loading.webAppInfo ? (
              ...
              <div className="flex flex-col items-center justify-center p-8 text-codeweaver-elements-textSecondary">
              ...
              <div className="grid grid-cols-2 gap-6">
                <div>
                  <h3 className="mb-4 text-base font-medium text-codeweaver-elements-textPrimary">Basic Information</h3>
                  <div className="space-y-3">
                    <div className="text-sm flex items-center gap-2">
                      <div className="i-ph:app-window text-codeweaver-elements-textSecondary w-4 h-4" />
                      <span className="text-codeweaver-elements-textSecondary">Name:</span>
                      <span className="text-codeweaver-elements-textPrimary">{webAppInfo.name}</span>
                    </div>
                    <div className="text-sm flex items-center gap-2">
                      <div className="i-ph:tag text-codeweaver-elements-textSecondary w-4 h-4" />
                      <span className="text-codeweaver-elements-textSecondary">Version:</span>
                      <span className="text-codeweaver-elements-textPrimary">{webAppInfo.version}</span>
                    </div>
                    <div className="text-sm flex items-center gap-2">
                      <div className="i-ph:certificate text-codeweaver-elements-textSecondary w-4 h-4" />
                      <span className="text-codeweaver-elements-textSecondary">License:</span>
                      <span className="text-codeweaver-elements-textPrimary">{webAppInfo.license}</span>
                    </div>
                    <div className="text-sm flex items-center gap-2">
                      <div className="i-ph:cloud text-codeweaver-elements-textSecondary w-4 h-4" />
                      <span className="text-codeweaver-elements-textSecondary">Environment:</span>
                      <span className="text-codeweaver-elements-textPrimary">{webAppInfo.environment}</span>
                    </div>
                    <div className="text-sm flex items-center gap-2">
                      <div className="i-ph:graph text-codeweaver-elements-textSecondary w-4 h-4" />
                      <span className="text-codeweaver-elements-textSecondary">Node Version:</span>
                      <span className="text-codeweaver-elements-textPrimary">{webAppInfo.runtimeInfo.nodeVersion}</span>
                    </div>
                  </div>
                </div>

                <div>
                  <h3 className="mb-4 text-base font-medium text-codeweaver-elements-textPrimary">Git Information</h3>
                  <div className="space-y-3">
                    <div className="text-sm flex items-center gap-2">
                      <div className="i-ph:git-branch text-codeweaver-elements-textSecondary w-4 h-4" />
                      <span className="text-codeweaver-elements-textSecondary">Branch:</span>
                      <span className="text-codeweaver-elements-textPrimary">{webAppInfo.gitInfo.local.branch}</span>
                    </div>
                    <div className="text-sm flex items-center gap-2">
                      <div className="i-ph:git-commit text-codeweaver-elements-textSecondary w-4 h-4" />
                      <span className="text-codeweaver-elements-textSecondary">Commit:</span>
                      <span className="text-codeweaver-elements-textPrimary">{webAppInfo.gitInfo.local.commitHash}</span>
                    </div>
                    <div className="text-sm flex items-center gap-2">
                      <div className="i-ph:user text-codeweaver-elements-textSecondary w-4 h-4" />
                      <span className="text-codeweaver-elements-textSecondary">Author:</span>
                      <span className="text-codeweaver-elements-textPrimary">{webAppInfo.gitInfo.local.author}</span>
                    </div>
                    <div className="text-sm flex items-center gap-2">
                      <div className="i-ph:clock text-codeweaver-elements-textSecondary w-4 h-4" />
                      <span className="text-codeweaver-elements-textSecondary">Commit Time:</span>
                      <span className="text-codeweaver-elements-textPrimary">{webAppInfo.gitInfo.local.commitTime}</span>
                    </div>
                    ...
                    {webAppInfo.gitInfo.github && (
                      <>
                        <div className="mt-4 pt-4 border-t border-gray-200 dark:border-gray-800">
                          <div className="text-sm flex items-center gap-2">
                            <div className="i-ph:git-fork text-codeweaver-elements-textSecondary w-4 h-4" />
                            <span className="text-codeweaver-elements-textSecondary">Repository:</span>
                            <span className="text-codeweaver-elements-textPrimary">
                          ...
                          <div className="mt-2 flex items-center gap-4 text-sm">
                            <div className="flex items-center gap-1">
                              ...
                              <span className="text-codeweaver-elements-textSecondary">
                        ...
                        {webAppInfo.gitInfo.github.upstream && (
                          <div className="mt-2">
                            <div className="text-sm flex items-center gap-2">
                              <div className="i-ph:git-fork text-codeweaver-elements-textSecondary w-4 h-4" />
                              <span className="text-codeweaver-elements-textSecondary">Upstream:</span>
                              <span className="text-codeweaver-elements-textPrimary">
            ...
            {webAppInfo && (
              <div className="mt-6">
                <h3 className="mb-4 text-base font-medium text-codeweaver-elements-textPrimary">Dependencies</h3>
        ...
        <CollapsibleTrigger className="w-full">
          <div className="flex items-center justify-between p-6 rounded-xl bg-white dark:bg-[#0A0A0A] border border-[#E5E5E5] dark:border-[#1A1A1A]">
            <div className="flex items-center gap-3">
              ...
              <h3 className="text-base font-medium text-codeweaver-elements-textPrimary">Error Check</h3>
              {errorLogs.length > 0 && (
          ...
          <div className="p-6 mt-2 rounded-xl bg-white dark:bg-[#0A0A0A] border border-[#E5E5E5] dark:border-[#1A1A1A]">
            <ScrollArea className="h-[300px]">
              <div className="space-y-4">
                <div className="text-sm text-codeweaver-elements-textSecondary">
                  Checks for:
                ...
                <div className="text-sm">
                  <span className="text-codeweaver-elements-textSecondary">Status: </span>
                  <span className="text-codeweaver-elements-textPrimary">
                    {loading.errors
                      ? 'Checking...'
                      : errorLogs.length > 0
                ...
                {errorLogs.length > 0 && (
                  <div className="mt-4">
                    <div className="text-sm font-medium text-codeweaver-elements-textPrimary mb-2">Recent Errors:</div>
                    <div className="space-y-2">
                      {errorLogs.map((error) => (
