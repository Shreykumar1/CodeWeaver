      ...
      >
        ...
        <div className="flex items-center justify-between gap-4 mt-8 mb-4">
          <div className="flex items-center gap-2">
            ...
            <div>
              <h4 className="text-md font-medium text-codeweaver-elements-textPrimary">Tab Management</h4>
              <p className="text-sm text-codeweaver-elements-textSecondary">Configure visible tabs and their order</p>
            </div>
          </div>
          ...
          <div className="relative w-64">
            ...
            <input
              ...
              className={classNames(
                ...
                'placeholder-codeweaver-elements-textTertiary',
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          ...
          {filteredTabs.some((tab) => DEFAULT_USER_TABS.includes(tab.id)) && (
            <div className="col-span-full flex items-center gap-2 mt-4 mb-2">
              ...
              <span className="text-sm font-medium text-codeweaver-elements-textPrimary">Default Tabs</span>
            </div>
          )}
          ...
          {filteredTabs
            ...
            .map((tab, index) => (
              <motion.div
                key={tab.id}
                className={classNames(
                  'rounded-lg border bg-codeweaver-elements-background text-codeweaver-elements-textPrimary',
                  'bg-codeweaver-elements-background-depth-2',
                ...
                <div className="flex items-start gap-4 p-4">
                  <motion.div
                    className={classNames(
                      ...
                      'transition-all duration-200',
                      tab.visible ? 'text-purple-500' : 'text-codeweaver-elements-textSecondary',
                    )}
          ...
          {filteredTabs.some((tab) => OPTIONAL_USER_TABS.includes(tab.id)) && (
            <div className="col-span-full flex items-center gap-2 mt-8 mb-2">
              ...
              <span className="text-sm font-medium text-codeweaver-elements-textPrimary">Optional Tabs</span>
            </div>
          )}
