    ...
    >
      <div className="flex items-center gap-4">
        <div className="cursor-grab">
          <div className="i-ph:dots-six-vertical w-4 h-4 text-codeweaver-elements-textSecondary" />
        </div>
        <div>
          <div className="font-medium text-codeweaver-elements-textPrimary">{TAB_LABELS[tab.id]}</div>
          {showControls && (
      ...
      {showControls && !tab.locked && (
        <div className="flex items-center gap-4">
          <div className="flex items-center gap-2">
            ...
            />
            <label className="text-sm text-codeweaver-elements-textSecondary">Visible</label>
          </div>
          <div className="flex items-center gap-2">
            <label className="text-sm text-codeweaver-elements-textSecondary">User</label>
            <Switch
            ...
            />
            <label className="text-sm text-codeweaver-elements-textSecondary">Dev</label>
          </div>
        </div>
      )}
    </motion.div>
