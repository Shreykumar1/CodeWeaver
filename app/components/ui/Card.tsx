  ...
  return (
    <div
      ...
      className={classNames(
        'rounded-lg border border-codeweaver-elements-borderColor bg-codeweaver-elements-background-depth-1 text-codeweaver-elements-textPrimary shadow-sm',
        className,
      )}
      {...props}
    />
...
const CardDescription = forwardRef<HTMLParagraphElement, React.HTMLAttributes<HTMLParagraphElement>>(
  ({ className, ...props }, ref) => {
    return <p ref={ref} className={classNames('text-sm text-codeweaver-elements-textSecondary', className)} {...props} />;
  },
);
