...
function getEditorTheme(settings: EditorSettings) {
  return EditorView.theme({
    ...
    '.cm-tooltip.cm-readonly-tooltip': {
      padding: '4px',
      whiteSpace: 'nowrap',
      backgroundColor: 'var(--codeweaver-elements-bg-depth-2)',
      borderColor: 'var(--codeweaver-elements-borderColorActive)',
      '& .cm-tooltip-arrow:before': {
        borderTopColor: 'var(--codeweaver-elements-borderColorActive)',
      },
