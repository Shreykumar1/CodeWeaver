...
export type codeweaverAction = FileAction | ShellAction | StartAction | BuildAction | SupabaseAction;

export type codeweaverActionData = codeweaverAction | BaseAction;
