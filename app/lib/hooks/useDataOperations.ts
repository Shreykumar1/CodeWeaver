...
export function useDataOperations({
  ...
  const handleExportSelectedSettings = useCallback(
    async (categoryIds: string[]) => {
      ...
      try {
        ...
        const a = document.createElement('a');
        a.href = url;
        a.download = `codeweaver-settings-${categoryIds.join('-')}.json`;
        document.body.appendChild(a);
        a.click();
        document.body.removeChild(a);
        URL.revokeObjectURL(url);
  ...
  const handleExportAllChats = useCallback(async () => {
    ...
    try {
      ...
      const a = document.createElement('a');
      a.href = url;
      a.download = 'codeweaver-chats.json';
      document.body.appendChild(a);
      a.click();
      document.body.removeChild(a);
      URL.revokeObjectURL(url);
  ...
  const handleExportSelectedChats = useCallback(
    async (chatIds: string[]) => {
      ...
      try {
        ...
        const a = document.createElement('a');
        a.href = url;
        a.download = 'codeweaver-selected-chats.json';
        document.body.appendChild(a);
        a.click();
        document.body.removeChild(a);
        URL.revokeObjectURL(url);
  ...
  const handleDownloadTemplate = useCallback(async () => {
    ...
    try {
      ...
      const a = document.createElement('a');
      a.href = url;
      a.download = 'codeweaver-api-keys-template.json';
      document.body.appendChild(a);
      a.click();
      document.body.removeChild(a);
      URL.revokeObjectURL(url);
  ...
  const handleExportAPIKeys = useCallback(async () => {
    ...
    try {
      ...
      const a = document.createElement('a');
      a.href = url;
      a.download = 'codeweaver-api-keys.json';
      document.body.appendChild(a);
      a.click();
      document.body.removeChild(a);
      URL.revokeObjectURL(url);
