...
export class WorkbenchStore {
  ...
  get codeweaverTerminal() {
    return this.#terminalStore.codeweaverTerminal;
  }
  get alert() {
  ...
  attachcodeweaverTerminal(terminal: ITerminal) {
    this.#terminalStore.attachcodeweaverTerminal(terminal);
  }
