...
const storedProfile = typeof window !== 'undefined' ? localStorage.getItem('codeweaver_profile') : null;
...
export const updateProfile = (updates: Partial<Profile>) => {
  ...
  if (typeof window !== 'undefined') {
    localStorage.setItem('codeweaver_profile', JSON.stringify(profileStore.get()));
  }
};
