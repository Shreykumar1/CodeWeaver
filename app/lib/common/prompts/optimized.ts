...
<artifact_info>
  ...
  - Use \`<codeweaverArtifact>\` tags with \`title\` and \`id\` attributes
  - Use \`<codeweaverAction>\` tags with \`type\` attribute:
    - shell: Run commands
...
## Artifact Usage
22. Use \`<codeweaverArtifact>\` tags with \`title\` and \`id\` attributes for each project
23. Use \`<codeweaverAction>\` tags with appropriate \`type\` attribute:
